    ...
    <div className="col-12  mb-6">
      <div className="card">
        <div className="row row-bordered g-0">
          <div className="col-6">
            <div
              className="card-header header-elements "
              style={{
                display: "flex",
            ...
            >
              <h5 className="card-title mb-0 ">Child Teeth Arch</h5>
              <small className="text-body-secondary">
                Present teeth position by universal numbering system
              </small>
            </div>
		...
		90.2,305.2 82.8,312.8 72,318.5 56.7,319.3 48.8,317.5 40.8,311.5 33,300.3 31.3,284.7 34.2,273.8 39.3,256.3 42.3,248 	"
          ...
          <div className="col-6">
            ...
            >
              <h5 className="card-title mb-0 ">Tooth Information</h5>
              <small className="text-body-secondary">
                Descripbe each tooth of the childs
              </small>
            </div>
            <div className="card-body pt-2" style={{ height: "150px" }}>
              <div className="tooth-content">
                <div className="tooth-info">
                  <span>Tooth Name: </span>
                  <span>{toothData && toothData.name}</span>
                </div>
                <div className="tooth-info">
                  <span>Tooth Number: </span>
                  <span>{toothData && toothData.numberOfTeeth}</span>
                </div>
                <div className="tooth-info">
                  <span>Tooth Description: </span>
                  <span>
                    {toothData &&
                      toothDList.at(toothData.numberOfTeeth).description}
                  </span>
                </div>
              </div>
            </div>
