...
const Chatbot = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            const botMessage = response.data?.candidates?.[0]?.content?.parts?.[0]?.text || "Xin lỗi, tôi không hiểu.";
            ...
            {isOpen ? (
                <div className="chatbot">
                    ...
                    <div className="chatbot-messages" ref={chatBoxRef}>
                        ...
                        {isTyping && <div className="bot-message typing">...</div>} {/* Hiển thị "..." khi bot đang gõ */}
                    </div>
